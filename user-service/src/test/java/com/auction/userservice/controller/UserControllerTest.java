...
class UserControllerTest {
    ...
    void testSavePreferences() throws Exception {
        ...
        UserPreferenceResponseDto response = UserPreferenceResponseDto.builder()
                .userId(1L)
                .location("India")
                .build();

        when(userService.savePreferences(1L, request)).thenReturn(response);
    ...
    void testGetPreferences() throws Exception {
        ...
        when(userService.getPreferences(1L)).thenReturn(response);
    ...
    void testGetAllBuyers() throws Exception {
        when(userService.getAllBuyers()).thenReturn(List.of());
    ...
    void testFilterBuyers() throws Exception {
        when(userService.filterBuyers("Electronics", 100.0, 1000.0, "India"))
                .thenReturn(List.of());

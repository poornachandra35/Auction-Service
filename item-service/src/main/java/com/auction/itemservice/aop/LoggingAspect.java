package com.auction.itemservice.aop;
...
public class LoggingAspect {
    ...
    @Around(
            "execution(* com.auction.itemservice.controller..*(..))"
    )
    ...
    @Around(
            "execution(* com.auction.itemservice.service..*(..))"
    )
    ...
    @Around(
            "execution(* com.auction.itemservice.scheduler..*(..))"
    )
